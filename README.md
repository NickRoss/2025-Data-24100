...
| 8: Docker Compose & MCP Intro | <ul><li>Docker Compose</li><li>Multi-container orchestration</li><li>LLMs, Agents, MCP introduction</li></ul> | <ul><li>[Project Part 6 Due](./project_assignments/part_6.md)</li><li>[Quiz 7A](./quiz/quiz7A.pdf)</li><li>[Answer Key](./quiz/quiz7AK.md)</li></ul>  | <ul><li>[Lesson Plan](./lesson_plan/week_8.md)</li></ul> |
| 9: MCP Implementation | <ul><li>MCP Server implementation</li><li>Async programming</li><li>HTTP streaming (SSE)</li><li>MCP tools and resources</li></ul> |  | <ul><li>[Lesson Plan](./lesson_plan/week_9.md)</li></ul> |
| 10: Finals Week |  | <ul><li>[Project Part 7 (Final Submission) Due](./project_assignments/part_7.md)</li><li>[Rubric](./project_assignments/part_7_rubric.md)</li><li>[Final Exam](./quiz/FinalExam.pdf)</li><li>[Answer Key](./quiz/FinalExam_AnswerKey.md)</li><li>In person Final</li></ul>  | <ul><li>[Lesson Plan](./lesson_plan/finals_week.md)</li></ul> |
