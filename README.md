...
| 9: MCP Implementation | <ul><li>MCP Server implementation</li><li>Async programming</li><li>HTTP streaming (SSE)</li><li>MCP tools and resources</li></ul> | <ul><li>[Project Part 7 Due](./project_assignments/part_7.md)</li></ul>  | <ul><li>[Lesson Plan](./lesson_plan/week_9.md)</li></ul> |
